...
const FIELD_LABELS: Record<string, string> = {
  ...
  "channel.blotataEnabled": "Blottata",
  "channel.driveInputFolderId": "Входная папка",
  "channel.driveArchiveFolderId": "Архивная папка",
  "channel.blotataApiKey": "Blottata API Key",
  "channel.blotataYoutubeId": "YouTube ID в Blottata",
  "channel.blotataTiktokId": "TikTok ID в Blottata",
  "channel.blotataInstagramId": "Instagram ID в Blottata",
  "channel.blotataFacebookId": "Facebook ID в Blottata",
  "channel.blotataFacebookPageId": "Facebook Page ID в Blottata",
  "channel.blotataThreadsId": "Threads ID в Blottata",
  "channel.blotataTwitterId": "Twitter ID в Blottata",
  "channel.blotataLinkedinId": "LinkedIn ID в Blottata",
  "channel.blotataPinterestId": "Pinterest ID в Blottata",
  "channel.blotataPinterestBoardId": "Pinterest Board ID в Blottata",
  "channel.blotataBlueskyId": "Bluesky ID в Blottata",
